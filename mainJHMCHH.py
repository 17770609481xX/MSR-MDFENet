...
def main(args):
    ...
    # 写入Excel文件
    train_result_ones_df.to_excel('result/JHMCHHTrainResultFile/train_' + args.val_name + '_1.xlsx', index=False)
    test_result_ones_df.to_excel('result/JHMCHHTrainResultFile/test_' + args.val_name + '_1.xlsx', index=False)
...
def multi_person_run():
    ...
    # 写入Excel文件
    result_df.to_excel('result/JHMCHHLOSO/JHMCHHLOSO_1.xlsx', index=False)
